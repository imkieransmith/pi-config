...
- **Colour Messages** (`colour-messages`) — Background colours: sand for your messages, a pale green for work (thinking and the gaps between tools, a shade lighter than tool rows), light blue for final responses. Leaves native loaders and editor borders unchanged.
